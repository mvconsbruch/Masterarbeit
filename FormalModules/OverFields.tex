...
\begin{defi}[$\pi$-divisible $A$-module]
  ...
  (constant) height of the endomorphism $[\pi]_H: H \to H$. 
\end{defi}
...
the formal $\cO_K$-module $F_\mathrm{norm}$ with $[\pi]_{F_\mathrm{norm}}(T) =
...
\begin{lem}\label{lem:inverseqisog}
  Let $f: F \to G$ be an isogeny of $\pi$-divisible formal $\cO_K$-module laws
