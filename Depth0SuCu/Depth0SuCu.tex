...
$\cO_C \llbr X_1^{q^{-\infty}}, \dots, X_n^{q^{-\infty}}\rrbr$, and define
systems of $q$-th power roots $\Delta'$ and $\tau'$ as
\begin{equation*}
  \begin{array}c
  \Delta'(x_1, \dots, x_n)^{q^{-m}} \coloneq (\xi^{q^{-m}})^{-(1 + q + \dots +
  q^{n-1})} \Delta(\xi x_1, \dots, \xi x_n) \in \cO_C \llbr x_1^{q^{-\infty}}, \dots
  , x_n^{q^{-\infty}}\rrbr  \\
  \text{and} \\
...
\ref{lem:ExplicitActionOnQthPowerRootSystems}. We have the following description
of group actions.
...
\begin{tabularx} {0.9\textwidth} { 
 ...
 \hline
 $(1, \alpha^{-1}, \sigma)$ & $a \mapsto \sigma(a)$ & $a \mapsto \sigma(a)$ & trivial \\
 \hline
 $(1, \varpi, \sigma)$ & $a \mapsto \sigma(a)$ & $a \mapsto \sigma(a)$ & $a
 \mapsto a^{q^{-n}}$ \\ [1ex] 
 \hline
\end{tabularx}
\end{center}
