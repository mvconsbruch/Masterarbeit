...
\begin{xpl}
  ...
  $\zeta_\ell \in \br \Q_p$ for a $\ell$-th root of unity. Let
  ...
  $\spf(R)$, where $R$ denotes the the $\br \Q_p$-algebra
  $R = \frac{\br \Q_p[X]}{(X^2 - \zeta_\ell)}$. Now, a Weil descent datum for 
  $\cP_{\zeta_\ell}$ is equvialent to a $\br \Q_p$-linear isomorphism of rings
  \begin{equation*}
    \alpha \colon \Phi^* R = \frac{\br \Q_p[X]}{X^2 - \zeta_\ell^{p^{-1}}} \to
    \frac{\br \Q_p[X]}{X^2 - \zeta_\ell} = R, 
  \end{equation*}
  where $p^{-1}$ denotes the inverse of $p$ modulo $\ell$. 
  One easily finds that any such isomorphism must 
  send $X$ to $aX$, where $a$ is a square root of $\zeta_\ell^{p^{-1}-1}$, and
  conversely any such square root yields a Weil descent datum. In particular,
  unlike the  Lubin--Tate deformation space, there
  is no canonical Weil descent datum for $\cP_{\zeta_\ell}$. 
\end{xpl}
