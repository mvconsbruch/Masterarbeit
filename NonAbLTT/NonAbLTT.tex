...
\begin{xpl}
  ...
  $\br \Q_p$-linear isomorphism of rings
  \begin{equation*}
  ...
  $\cP_{\zeta_\ell}$. 
    \item More generally, if $\cG$ is representable by the formal spectrum of a 
      ...
      \begin{equation*}
        ...
        \to 
        \frac{ \cO_{\br E}\llbr X_1, \dots, X_n \rrbr}{(f_1^{\Phi}, \dots,
        f_n^{\Phi})} = \Phi^{-1,*}R,
      \end{equation*}
      where $f_i^\Phi \in \cO_\br E\llbr X_1, \dots, X_n\rrbr$ denotes the 
      power series obtained by applying $\Phi$ to the coefficients of $f_i$.
  \end{enumerate}
\end{xpl}
