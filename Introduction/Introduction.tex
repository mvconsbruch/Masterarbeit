...
\begin{thm*}[Main Results of this Thesis]
  \leavevmode \begin{enumerate}
    ...
    \item Let $\pi$ be a depth zero supercuspidal representation of $\GL_n(E)$.
      Admitting the results of non-Abelian Lubin--Tate theory, we can
      calculate $\rec_E(\pi)$ and $\JL(\pi)$ explicitly using arguments that
      purely rely on the geometry of the Lubin--Tate tower.
  \end{enumerate}
\end{thm*}
