...
\begin{lem}\label{lem:ActionsOnDLn}
  ...
  \begin{equation*}
    x_i  \mapsto  \sum_{j = 1}^n a_{ij}x_j \quad i = 1, \dots, n. 
  \end{equation*}
  Similarly, an element $d \in \FF_{q^n}^\times$ acts via
  \begin{equation*}
    x_i \mapsto d x_i \quad i = 1, \dots, n.
  \end{equation*}
\end{lem}
...
the subgroup of elements in $\GL_n \times \FF_{q^n}^\times \times \Z$
stabilizing $Y_b$ is, for every $b$, given by
\begin{equation*}
