...
\begin{proof}
  ...
  Proposition rcef{prop:FlagVarietyAsQuotient}.
\end{proof}
\end{lem}
...
\begin{proof}
  ...
  By \cref{lem:RelativePositionVecCrit}, there is a basis 
...
\begin{defi}[Regular Character on $\FF_{q^n}^\times$]\label{def:RegChar}
...
The statements of \cref{thm:DLTheoryGeneralResults} reduce to
the following.
...
\begin{thm}[Structure of $\hH_\DL$]\label{thm:MainThmHDlStructure}
  ...
  Deligne--Lusztig theory (cf. \cref{thm:DLCorrespondenceForUs}), and
